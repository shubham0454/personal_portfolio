              ...
              <div key={project.id} id={project.id} className="scroll-mt-20 sm:scroll-mt-28">
                <AnimatedSection animation="fade" delay={index * 80}>
                  <div className="grid items-start gap-8 md:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:gap-16">
                    ...
                    <div className={cn("flex flex-col gap-4", isEven ? "" : "md:order-1")}>
                      <Card
                        className="relative overflow-hidden border-2 border-border bg-card/80 backdrop-blur-lg transition-all duration-500 hover:border-primary hover:shadow-2xl flex flex-col"
                      >
                        ...
                        <CardContent className="p-4 sm:p-5 bg-background border-t border-border/50">
                          <h4 className="text-xs sm:text-sm font-semibold uppercase tracking-wide text-foreground mb-2">Tech Stack</h4>
