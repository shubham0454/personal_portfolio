    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-hero relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
        <div>
          ...
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8 sm:mb-12 px-4 leading-relaxed">
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-8 sm:mb-12 mt-8 sm:mt-12 px-4">
            <Button
